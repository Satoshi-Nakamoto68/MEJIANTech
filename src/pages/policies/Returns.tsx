  ...
  const howToReturnSteps = [
    <>
      ...
      <a
        ...
        className="text-purple-400 hover:text-purple-300 transition-colors duration-300 underline font-medium"
      >
      ...
      <a
        ...
        className="text-cyan-400 hover:text-cyan-300 transition-colors duration-300 underline font-medium"
      >
        +852 47486175
      </a>{" "}
