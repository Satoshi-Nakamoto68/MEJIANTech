                  ...
                  <div className="space-y-6">
                    {companyInfo.map((info, index) => (
                      <div
                        ...
                        className="group/item flex gap-4 p-5 rounded-xl bg-slate-800/50 backdrop-blur-sm border border-slate-700/30 hover:border-cyan-500/30 transition-all duration-300 hover:shadow-lg"
                        style={{
                          opacity: mounted ? 1 : 0,
                      ...
                      >
                        <div className="flex-shrink-0 w-12 h-12 rounded-lg bg-gradient-to-br from-cyan-500/10 to-blue-500/10 flex items-center justify-center border border-cyan-500/20 group-hover/item:scale-110 transition-transform duration-300">
