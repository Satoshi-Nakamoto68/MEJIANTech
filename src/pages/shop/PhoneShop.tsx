...
const PhoneShop = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Phone Accessories | MEJIAN Global Technology</title>
        <meta
          name="description"
          content="Shop quality phone accessories including cases, chargers, earbuds, stands, and power banks from MEJIAN Global Technology."
        />
      </Helmet>
      ...
      <Layout>
        ...
        >
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div
              ...
              style={{ animation: "phoneShopOrb 22s ease-in-out infinite" }}
            />
            <div
              className="absolute bottom-0 right-1/4 w-96 h-96 rounded-full blur-3xl bg-blue-500/5"
              style={{
                animation:
                  "phoneShopOrb 20s ease-in-out infinite reverse",
                animationDelay: "3s",
              }}
            />
            <div
              ...
              style={{
                animation: "phoneShopOrb 24s ease-in-out infinite",
                animationDelay: "6s",
              }}
            />
          </div>
          <div
            ...
            style={{
              ...
              animation: "phoneShopShimmer 10s ease-in-out infinite",
            }}
          />
          ...
          <div className="container mx-auto relative z-10 px-4 text-center">
            ...
            >
              ...
              >
                ...
                <span className="bg-gradient-to-r from-cyan-400 via-blue-400 to-cyan-400 bg-clip-text text-transparent bg-[length:200%_100%] animate-phoneShopGradient">
                  Accessories
                </span>
              </h1>
              ...
              >
                Cases, chargers, earbuds, stands & power banks. Everything you
                need to enhance and protect your device.
              </p>
          ...
          <div className="container mx-auto relative z-10 px-4">
            ...
            >
              <p className="text-slate-400">
                ...
                {phoneProducts.length === 1 ? "product" : "products"}
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 lg:gap-8">
              {phoneProducts.map((product, index) => (
                <div
                  ...
                  className="product-card-phone-reveal"
                  style={{
                    opacity: mounted ? 1 : 0,
                    transform: mounted
        ...
        <style>{`
          @keyframes phoneShopOrb {
            0%, 100% { transform: translate(0, 0) scale(1); opacity: 0.7; }
            50% { transform: translate(30px, -30px) scale(1.1); opacity: 1; }
          }
          @keyframes phoneShopShimmer {
            0% { transform: translateX(-100%); }
            100% { transform: translateX(200%); }
          }
          @keyframes phoneShopGradient {
            0%, 100% { background-position: 0% 50%; }
            50% { background-position: 100% 50%; }
          }
          .animate-phoneShopGradient {
            animation: phoneShopGradient 3s ease-in-out infinite;
          }
          .product-card-phone-reveal { opacity: 0; }
          .product-card-phone-reveal.revealed { opacity: 1; }
        `}</style>
      </Layout>
    </>
  );
