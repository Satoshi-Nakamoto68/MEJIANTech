...
const HomeShop = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Smart Home | MEJIAN Global Technology</title>
        <meta
          name="description"
          content="Shop smart home devices including smart lighting, security cameras, smart plugs, sensors, and automation solutions from MEJIAN Global Technology."
        />
      </Helmet>
      ...
      <Layout>
        ...
        >
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div
              ...
              style={{ animation: "homeShopOrb 22s ease-in-out infinite" }}
            />
            <div
              className="absolute bottom-0 right-1/4 w-96 h-96 rounded-full blur-3xl bg-blue-500/5"
              style={{
                animation: "homeShopOrb 20s ease-in-out infinite reverse",
                animationDelay: "3s",
              }}
            />
            <div
              ...
              style={{
                animation: "homeShopOrb 24s ease-in-out infinite",
                animationDelay: "6s",
              }}
            />
          </div>
          <div
            ...
            style={{
              ...
              animation: "homeShopShimmer 10s ease-in-out infinite",
            }}
          />
          ...
          <div className="container mx-auto relative z-10 px-4 text-center">
            ...
            >
              ...
              >
                ...
                <span className="bg-gradient-to-r from-cyan-400 via-blue-400 to-cyan-400 bg-clip-text text-transparent bg-[length:200%_100%] animate-homeShopGradient">
                  Home
                </span>
              </h1>
              ...
              >
                Smart lighting, security cameras, sensors, and automation
                solutions. Transform your home into an intelligent living space.
              </p>
          ...
          <div className="container mx-auto relative z-10 px-4">
            ...
            >
              <p className="text-slate-400">
                ...
                {homeProducts.length === 1 ? "product" : "products"}
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 lg:gap-8">
              {homeProducts.map((product, index) => (
                <div
                  ...
                  className="product-card-home-reveal"
                  style={{
                    opacity: mounted ? 1 : 0,
                    transform: mounted
        ...
        <style>{`
          @keyframes homeShopOrb {
            0%, 100% { transform: translate(0, 0) scale(1); opacity: 0.7; }
            50% { transform: translate(30px, -30px) scale(1.1); opacity: 1; }
          }
          @keyframes homeShopShimmer {
            0% { transform: translateX(-100%); }
            100% { transform: translateX(200%); }
          }
          @keyframes homeShopGradient {
            0%, 100% { background-position: 0% 50%; }
            50% { background-position: 100% 50%; }
          }
          .animate-homeShopGradient {
            animation: homeShopGradient 3s ease-in-out infinite;
          }
          .product-card-home-reveal { opacity: 0; }
          .product-card-home-reveal.revealed { opacity: 1; }
        `}</style>
      </Layout>
    </>
  );
